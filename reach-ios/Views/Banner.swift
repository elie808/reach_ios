...
open class Banner: UIView {
    ...
    //TODO: UIApplication.shared.setStatusBarStyle has been deprecated, so it doesn't make sense using this here anymore
    //      should probably abstract somewhere else
